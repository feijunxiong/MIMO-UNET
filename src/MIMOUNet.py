...
class MIMOUNet(nn.Cell):
    ...
    def interpolate_up(self, input, scale_factor):
        _, _, h, w = input.shape
        h = h * scale_factor
        w = w * scale_factor
    ...
    def construct(self, x):
        x_2 = self.interpolate_down(x, scale_factor=2)
        x_4 = self.interpolate_down(x_2, scale_factor=2)
        z2 = self.SCM2(x_2)
        z4 = self.SCM1(x_4)
        ...
        z12 = self.interpolate_down(res1, scale_factor=2)
        z21 = self.interpolate_up(res2, scale_factor=2)
        z42 = self.interpolate_up(z, scale_factor=2)
        z41 = self.interpolate_up(z42, scale_factor=2)
